...
class GenericAdapter:
    def __init__(self, name: str, *, reasoning=False, cache=False, mode="browser"):
        self.capabilities=ProviderCapabilities(name, reasoning, cache, True, mode)
...
ADAPTERS={
    ...
    "ollama":GenericAdapter("ollama",mode="local"),
    "lmstudio":GenericAdapter("lmstudio",mode="local"),
}
